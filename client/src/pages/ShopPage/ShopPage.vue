            ...
            <div class="shop_filters-wrapper">
                <div class="shop_filters-left">
                    <div class="shop_filters-left-buttons">
                        ...
                        <button class="shop_grid-button" @click="changeGrid">
                    ...
                    <div class="shop_filters-shows">
                        <p>{{ `Showing 1-${products.length} of ${totalProducts.length} results` }}</p>
                    </div>
                </div>
                <div class="shop_filter-right">
                </div>
            </div>
        </div>
